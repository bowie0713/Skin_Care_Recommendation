...
#   filter(
#     !str_detect(link, "hair|shampoo|conditioner")
#   )
...
#Testing
test_links = categorized_df['link'][1000:1003]
...
for link in test_links:
    try:
        ...
        prod_name = soup.find('span', {"data-at": "product_name"}).text if prod_name else "N/A"
        cleaned_name = " ".join(word for word in product_name.split() if word.lower() != "hair")
        ...
        # filter makeup out 
        #skin_concerns = skin_concerns if skin_concerns != "N/A" else continue
        #skin_type = skin_type if skin_type != "N/A" else continue
