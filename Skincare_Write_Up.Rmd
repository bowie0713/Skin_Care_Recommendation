...
df = pd.read_excel("~Skin_Care_Recommendation/data/filtered_sephora.xlsx")
df
...
Our final system uses the product attributes from Sephora's list—ingredients, skin concerns, and brand names—to recommend similar skincare products. This approach balances personalization with respect for privacy, delivering a recommendation system that is both effective and ethical.
