...
def give_recommendation(product_name):
    ...
    top_10 = top_10.merge(df_recommend2[['Product Name', 'Product Rating']], on="Product Name", how="left")
...
1.  **Text Vectorization**: We implemented the same process as our cosine similarity recommender system, converting textual data (e.g., ingredients, descriptions) into vectors using TF-IDF (Term Frequency-Inverse Document Frequency). In addition, **we added** **weight to `Brand Name` and `Product Category`** for a fine-tuned similarity calculation.
